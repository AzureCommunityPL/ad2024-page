...
import agnieszkaCentImage from '@/images/avatars/organizers/agnieszka-cent.jpg';
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-4 font-display text-2xl tracking-tight text-blue-900">
            Od lat nieugięci, niestrudzeni i zawsze wierni. Poznaj zespół organizatorów AzureDay Poland 2024
          </p>
        </div>
        <Tab.Group
          as="div"
